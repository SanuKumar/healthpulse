      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Bajaj BlueCross BlueShield"
          />
          <CustomFormField
            fieldType={FormFieldType.INPUT}
            control={form.control}
            name="insurancePolicyNumber"
            label="Insurance polcy number"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField
            ...
            placeholder="Ibuprofen 200mg, Paracetanol 500mg"
          />
        </div>
        ...
        <CustomFormField
          ...
          label="I consent to discloser of information"
        />
        <CustomFormField
          fieldType={FormFieldType.CHECKBOX}
          control={form.control}
